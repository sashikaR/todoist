...
public class TestProjectTaskUpdate extends TestBase {
    ...
    private void createProject() throws JsonProcessingException {
        ...
        taskId = String.valueOf(createdTask.getId());
    }

    @Test(testName = "UPDATE-TASK_V1_API_001", description = "Validate successful task modification ", priority = 1, suiteName = "Regression")
    public void updateTaskSuccessfully() throws JsonProcessingException {
        ...
        Response createTaskResponse = sendData(httpRequest.body(task), testProperties.getProperty("todo-list-update-task-url"),taskId);
        softAssert.assertEquals(createTaskResponse.getStatusCode(), 204);
